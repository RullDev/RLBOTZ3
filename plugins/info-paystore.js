...
let info = `
╭━━━━「 *SEWA BOT* 」
┊⫹⫺ *Hemat:* _${sh}k/Run Bot (1 minggu)_
...
const sections = [
   {
	...
	{title: "🔖 𝗩𝗜𝗣", rowId: '.order *Paket:* VIP • Sewa', description: '𝗣𝗿𝗶𝗰𝗲: ' + sp + 'k (12 bulan)' },
	{title: "🔖 ɢᴀɴᴛɪ ɴᴀᴍᴀʙᴏᴛ", rowId: '.order *Paket:* Ganti Nama Bot+Owner • Sewa', description: '𝗣𝗿𝗶𝗰𝗲: ' + sv },
	]
    }, {
